    ...
    public void onRadioButtonClicked(View view){
        ...
        switch(view.getId()) {
            case R.id.radioButtonShip1:
                if (checked){
                    Toast toast1 = Toast.makeText(this, "Fighter is currently selected!", Toast.LENGTH_LONG);
                    toast1.show();
                    String chosenShip = "Fighter";
            ...
            case R.id.radioButtonShip2:
                if (checked){
                    Toast toast2 = Toast.makeText(this, "Racer is currently selected!", Toast.LENGTH_LONG);
                    toast2.show();
                    String chosenShip = "Racer";
                    mEditor.putString("com.example.kentec.catchastarship.chosenShip", chosenShip);
                    mEditor.commit();
                    break;
                }
            case R.id.radioButtonShip3:
                if (checked){
                    Toast toast3 = Toast.makeText(this, "Cruiser is currently selected!", Toast.LENGTH_LONG);
                    toast3.show();
                    String chosenShip = "Cruiser";
                    mEditor.putString("com.example.kentec.catchastarship.chosenShip", chosenShip);
                    mEditor.commit();
                    break;
                }
